...
// FP8 I/O utilities (renamed from sparse_fp8/components/dequant.h, with
// cvt_fp8x8_bf16x8 dropped). Renaming rationale: FP8 R5 is end-to-end FP8
// with no dequant step; the remaining content is FP8 vector types plus
// generic gmem load helpers.
//
// Changes vs original:
//   keep:  fp8x8 / fp8x16 / L1CacheHint / L2PrefetchHint /
//          load_128b_from_gmem / load_64b_from_gmem
//   drop:  cvt_fp8x8_bf16x8 (FP8 R5 feeds wgmma directly with fp8 operands;
//          no dequant path needed)
//   namespace: sparse_fp8 -> sparse_native_fp8
